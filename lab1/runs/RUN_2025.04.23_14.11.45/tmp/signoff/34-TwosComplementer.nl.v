module TwosComplementer (x,
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_1_16 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_1_22 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_3_38 ();
 ...
 sky130_fd_sc_hd__clkbuf_1 _25_ (.A(net1),
    .X(net9));
 sky130_fd_sc_hd__dlymetal6s2s_1 input1 (.A(x[0]),
    .X(net1));
 sky130_fd_sc_hd__buf_1 input2 (.A(x[1]),
    .X(net2));
 sky130_fd_sc_hd__buf_1 input3 (.A(x[2]),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_1 input4 (.A(x[3]),
    .X(net4));
 sky130_fd_sc_hd__buf_1 input5 (.A(x[4]),
    .X(net5));
 sky130_fd_sc_hd__buf_1 input6 (.A(x[5]),
    .X(net6));
